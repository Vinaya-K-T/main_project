<%@ Page Title="" Language="C#" MasterPageFile="~/userr/Site1.Master" AutoEventWireup="true" CodeBehind="view_feedback.aspx.cs" Inherits="pothole_detection_system.userr.WebForm2" %>
					...
					<section class="scrollable padder">
						...
						<section class="panel panel-default">
							...
							<div class="table-responsive">
									<asp:GridView ID="GridView1" runat="server" class="table table-striped m-b-none">
									</asp:GridView>	
							</div>
						</section>
					</section>
