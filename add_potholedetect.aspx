<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Site1.Master" AutoEventWireup="true" CodeBehind="add_potholedetect.aspx.cs" Inherits="pothole_detection_system.Admins.WebForm15" %>
									...
									<table class="table table-bordered">
										...
										<tr>
									        ...
									        <td>
												...
												<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="st"></asp:RequiredFieldValidator>
											</td>
										</tr>
										<tr>
											<th>uid:</th>
